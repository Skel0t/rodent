...
void read_in_oidn(anydsl::Array<float>* weights, anydsl::Array<float>* biases, std::string network_path) {
    ...
    *biases  = anydsl::Array<float>(memsize_biases);
    ...
    int offset = 0;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/enc_conv0.weight.txt", ic, ec1, 3);
    offset += memsize1;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/enc_conv1.weight.txt", ec1, ec1, 3);
    offset += memsize2;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/enc_conv2.weight.txt", ec1, ec2, 3);
    offset += memsize3;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/enc_conv3.weight.txt", ec2, ec3, 3);
    offset += memsize4;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/enc_conv4.weight.txt", ec3, ec4, 3);
    offset += memsize5;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/enc_conv5a.weight.txt", ec4, ec5, 3);
    offset += memsize6;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/enc_conv5b.weight.txt", ec5, ec5, 3);
    offset += memsize7;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv4a.weight.txt", (ec5+ec3), dc4, 3);
    offset += memsize8;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv4b.weight.txt", dc4, dc4, 3);
    offset += memsize9;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv3a.weight.txt", (dc4+ec2), dc3, 3);
    offset += memsize10;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv3b.weight.txt", dc3, dc3, 3);
    offset += memsize11;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv2a.weight.txt", (dc3+ec1), dc2, 3);
    offset += memsize12;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv2b.weight.txt", dc2, dc2, 3);
    offset += memsize13;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv1a.weight.txt", (dc2+ic), dc1a, 3);
    offset += memsize14;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv1b.weight.txt", dc1a, dc1b, 3);
    offset += memsize15;
    read_in_weigths_chw(weights->data(), offset, network_path + "/oidn_dump/dec_conv0.weight.txt", dc1b, oc, 3);

    // std::cout << weights->data()[offset] << " " << weights->data()[offset + memsize16 -1] << " " << weights->data()[memsize1+1] << std::endl;

    offset = 0;
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/enc_conv0.bias.txt",  ec1);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/enc_conv1.bias.txt",  ec1);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/enc_conv2.bias.txt",  ec2);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/enc_conv3.bias.txt", ec3);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/enc_conv4.bias.txt",  ec4);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/enc_conv5a.bias.txt",  ec5);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/enc_conv5b.bias.txt",  ec5);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv4a.bias.txt",  dc4);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv4b.bias.txt",  dc4);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv4a.bias.txt",  dc3);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv3b.bias.txt",  dc3);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv2a.bias.txt",  dc2);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv2b.bias.txt",  dc2);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv1a.bias.txt",  dc1a);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv1b.bias.txt",  dc1b);
    read_in_biases(biases->data(), offset, network_path + "/oidn_dump/dec_conv0.bias.txt",  oc);
